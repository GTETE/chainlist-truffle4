...
contract('ChainList', function(accounts) {
    ...
    it("should throw an exception if you try to buy an article when there is no article yet", function(){
    ...
    it("should trhow an exception if you try buy your own article", function(){
        return ChainList.deployed().then(function(instance){
            chainListInstance = instance;
    ...
    //trying to buy a product to a value that does not corresponf to its price
    it("should throw an error if you try to by a product at incorrect price", function(){
        return ChainList.deployed().then(function (instance) {
            chainListInstance = instance;
    ...
    it("should throw an error if you try to buy an article already sold", function(){
        return ChainList.deployed().then(function (instance) {
            chainListInstance = instance;
